...
public final class AssignmentRowBinding implements ViewBinding {
  ...
  private AssignmentRowBinding(@NonNull ConstraintLayout rootView, @NonNull TextView classView,
  ...
  public static AssignmentRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AssignmentRowBinding((ConstraintLayout) rootView, classView, delete, edit,
