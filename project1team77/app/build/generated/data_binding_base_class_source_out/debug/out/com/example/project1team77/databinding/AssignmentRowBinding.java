...
public final class AssignmentRowBinding implements ViewBinding {
  @NonNull
  ...
  private AssignmentRowBinding(@NonNull ConstraintLayout rootView, @NonNull TextView courseView,
  ...
  @NonNull
  public static AssignmentRowBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AssignmentRowBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.assignment_row, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AssignmentRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AssignmentRowBinding((ConstraintLayout) rootView, courseView, delete, dueDateView,
          edit, nameView);
    }
